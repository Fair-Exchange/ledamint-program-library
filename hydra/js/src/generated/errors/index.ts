...
/**
 * InvalidCloseAccountDestination: 'Sending Safe to a SPL token destination will render the sol unusable'
 *
 * @category Errors
 * @category generated
 */
export class InvalidCloseAccountDestinationError extends Error {
  ...
  constructor() {
    super('Sending Safe to a SPL token destination will render the sol unusable');
    if (typeof Error.captureStackTrace === 'function') {
