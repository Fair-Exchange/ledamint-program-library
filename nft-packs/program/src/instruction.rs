...
pub enum NFTPacksInstruction {
    ...
    #[account(0, writable, name = "pack_set")]
    #[account(1, signer, name = "authority")]
    #[account(2, name = "clock", desc = "Safecoin Clock")]
    ClosePack,
    ...
    /// DeletePack
    ///
    /// Transfer all the SAFE from pack set account to refunder account and thus remove it.
    ///
    #[account(0, writable, name = "pack_set")]
    #[account(1, signer, name = "authority")]
    ...
    /// DeletePackCard
    ///
    /// Transfer all the SAFE from pack card account to refunder account and thus remove it.
    ...
    /// DeletePackVoucher
    ///
    /// Transfer all the SAFE from pack voucher account to refunder account and thus remove it.
    ///
    #[account(0, writable, name = "pack_set")]
    ...
    #[account(8, name = "recent_slothashes", desc = "Safecoin Slot Hashes")]
    #[account(9, name = "clock", desc = "Safecoin Clock")]
