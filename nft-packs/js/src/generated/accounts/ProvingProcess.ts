...
export class ProvingProcess implements ProvingProcessArgs {
  ...
  static gpaBuilder(
    ...
    return beetSafecoin.GpaBuilder.fromStruct(programId, provingProcessBeet);
  }
...
export const provingProcessBeet = new beet.FixableBeetStruct<ProvingProcess, ProvingProcessArgs>(
  [
    ...
    ['walletKey', beetSafecoin.publicKey],
    ['isExhausted', beet.bool],
    ['voucherMint', beetSafecoin.publicKey],
    ['packSet', beetSafecoin.publicKey],
