...
/**
 * NotEnoughSAFE: 'Not enough SAFE to pay for this minting'
 *
 * @category Errors
 * @category generated
 */
export class NotEnoughSAFEError extends Error {
  readonly code: number = 0x1778;
  readonly name: string = 'NotEnoughSAFE';
  constructor() {
    super('Not enough SAFE to pay for this minting');
    if (typeof Error.captureStackTrace === 'function') {
      Error.captureStackTrace(this, NotEnoughSAFEError);
    }
  }
}

createErrorFromCodeLookup.set(0x1778, () => new NotEnoughSAFEError());
createErrorFromNameLookup.set('NotEnoughSAFE', () => new NotEnoughSAFEError());
