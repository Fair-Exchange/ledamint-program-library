...
// NOTE: Safeita has to be yarn linked at the moment until it is published and installed here
const { Safeita } = require('@metaplex-foundation/solita');
...
async function generateTypeScriptSDK() {
  ...
  const gen = new Safeita(idl, { formatCode: true });
