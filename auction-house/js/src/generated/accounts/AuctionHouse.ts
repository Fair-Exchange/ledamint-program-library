...
export class AuctionHouse implements AuctionHouseArgs {
  ...
  static gpaBuilder(
    ...
    return beetSafecoin.GpaBuilder.fromStruct(programId, auctionHouseBeet);
  }
...
>(
  [
    ...
    ['auctionHouseFeeAccount', beetSafecoin.publicKey],
    ['auctionHouseTreasury', beetSafecoin.publicKey],
    ['treasuryWithdrawalDestination', beetSafecoin.publicKey],
    ['feeWithdrawalDestination', beetSafecoin.publicKey],
    ['treasuryMint', beetSafecoin.publicKey],
    ['authority', beetSafecoin.publicKey],
    ['creator', beetSafecoin.publicKey],
    ['bump', beet.u8],
    ...
    ['auctioneerAddress', beetSafecoin.publicKey],
