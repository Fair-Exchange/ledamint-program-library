...
programCommand('update_auction_house')
  .option(
    '-tm, --treasury-mint <string>',
    'Mint address of treasury used during creation. If not used, default to SAFE. Ignored if providing -ah arg',
  )
  .option(
    '-ah, --auction-house <string>',
    'Specific auction house(if not provided, we assume you are asking for your own)',
...
function programCommand(name: string) {
  return program
    ...
    .option(
      '-e, --env <string>',
      'Safecoin cluster env name, i.e. mainnet-beta, testnet, devnet',
