...
export class Market implements MarketArgs {
  ...
  static gpaBuilder(
    ...
    return beetSafecoin.GpaBuilder.fromStruct(programId, marketBeet);
  }
...
>(
  [
    ...
    ['store', beetSafecoin.publicKey],
    ['sellingResource', beetSafecoin.publicKey],
    ['treasuryMint', beetSafecoin.publicKey],
    ['treasuryHolder', beetSafecoin.publicKey],
    ['treasuryOwner', beetSafecoin.publicKey],
    ['owner', beetSafecoin.publicKey],
