...
export class SellingResource implements SellingResourceArgs {
  ...
  static gpaBuilder(
    ...
    return beetSafecoin.GpaBuilder.fromStruct(programId, sellingResourceBeet);
  }
...
>(
  [
    ...
    ['resource', beetSafecoin.publicKey],
    ['vault', beetSafecoin.publicKey],
    ['vaultOwner', beetSafecoin.publicKey],
    ['supply', beet.u64],
