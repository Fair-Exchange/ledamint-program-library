...
pub struct CliArgs {
    /// RPC endpoint.
    #[clap(short, long, default_value_t = String::from("https://api.mainnet-beta.safecoin.org"), value_name = "URL")]
    pub url: String,

    /// Path to transaction payer keypair file.
    #[clap(short, long, default_value_t = format!("{}/.config/safecoin/id.json", env::var("HOME").unwrap()), value_name = "FILE")]
