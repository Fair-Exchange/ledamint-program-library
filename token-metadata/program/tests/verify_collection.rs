...
mod verify_collection {
    ...
    async fn success_verify_collection_with_authority() {
        ...
        let ix = lpl_token_metadata::instruction::approve_collection_authority(
    ...
    async fn success_set_and_verify_collection_with_authority_and_revoke_as_delegate() {
        ...
        let ix_revoke = lpl_token_metadata::instruction::revoke_collection_authority(
            lpl_token_metadata::id(),
            record,
            new_collection_authority.pubkey(),
            new_collection_authority.pubkey(),
    ...
    async fn fail_verify_collection_with_authority() {
        ...
        let ixrevoke = lpl_token_metadata::instruction::revoke_collection_authority(
            lpl_token_metadata::id(),
            record,
            new_collection_authority.pubkey(),
            context.payer.pubkey(),
...
async fn fail_invalid_collection_update_authority() {
    ...
    let ix1 = lpl_token_metadata::instruction::approve_collection_authority(
        lpl_token_metadata::id(),
        record,
        delegate_keypair.pubkey(),
        update_authority,
