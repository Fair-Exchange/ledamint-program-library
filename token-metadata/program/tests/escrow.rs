...
mod escrow {
    ...
    async fn smoke_test_success() {
        ...
        let ix0 = lpl_token_metadata::escrow::create_escrow_account(
        ...
        let escrow: lpl_token_metadata::state::TokenOwnedEscrow =
        ...
        let ix0 = safe_associated_token_account::instruction::create_associated_token_account(
            &context.payer.pubkey(),
            &escrow_address.0,
            &attribute_test_metadata.mint.pubkey(),
            &safe_token::ID,
        );
        let ix1 = safe_token::instruction::transfer(
            &safe_token::id(),
        ...
        let attribute_src =
            safe_token::state::Account::unpack_from_slice(&attribute_src_account.data).unwrap();
        ...
        let attribute_dst =
            safe_token::state::Account::unpack_from_slice(&attribute_dst_account.data).unwrap();
        ...
        let ix2 = lpl_token_metadata::escrow::transfer_out_of_escrow(
            lpl_token_metadata::id(),
            escrow_address.0,
            parent_test_metadata.pubkey,
            context.payer.pubkey(),
    ...
    async fn double_transfer_out() {
        ...
        let ix3 = lpl_token_metadata::escrow::transfer_out_of_escrow(
            lpl_token_metadata::id(),
            escrow_address.0,
            parent_test_metadata.pubkey,
            context.payer.pubkey(),
