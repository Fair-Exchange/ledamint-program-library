...
mod standard_transfer {
    ...
    async fn transfer_nonfungible() {
        ...
        airdrop(&mut context, &destination_owner, LAMPORTS_PER_SAFE)
            .await
            .unwrap();
        ...
        let token_account = safe_token::state::Account::unpack(
            &context
                .banks_client
    ...
    async fn transfer_with_delegate() {
        ...
        airdrop(&mut context, &delegate.pubkey(), LAMPORTS_PER_SAFE)
            .await
            .unwrap();
        ...
        let authority_token: safe_token::state::Account =
            safe_token::state::Account::unpack(&authority_token_account.data).unwrap();
    ...
    async fn fake_delegate_fails() {
        ...
        airdrop(&mut context, &fake_delegate.pubkey(), LAMPORTS_PER_SAFE)
            .await
            .unwrap();
...
mod auth_rules_transfer {
    ...
    async fn wallet_to_wallet() {
        ...
        // the lpl-token-metadata. This should fail because it's not
    ...
    async fn owner_transfer() {
        ...
        let dest_token_account = safe_token::state::Account::unpack(
        ...
        let authority_ata_account = safe_token::state::Account::unpack(
    ...
    async fn transfer_delegate() {
        ...
        let rooster_ata_account = safe_token::state::Account::unpack(
    ...
    async fn no_auth_rules_skips_validation() {
        ...
        // Our destination will be an account owned by the lpl-token-metadata
    ...
    async fn escrowless_delegate_transfer() {
        ...
        let payer = context.payer.dirty_clone();
        airdrop(&mut context, &rooster_manager.pda(), LAMPORTS_PER_SAFE)
            .await
            .unwrap();
        ...
        let source_ata_account = safe_token::state::Account::unpack(
        ...
        let destination_ata_account = safe_token::state::Account::unpack(
