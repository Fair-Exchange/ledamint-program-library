...
use lpl_token_metadata::state::{UseMethod, Uses};
...
mod uses {
    ...
    async fn single_use_wrong_user_fail() {
        ...
        let ix = lpl_token_metadata::instruction::utilize(
    ...
    async fn multi_use_delegated_success() {
        ...
        let add_use_authority = lpl_token_metadata::instruction::approve_use_authority(
            lpl_token_metadata::id(),
            record,
        ...
        let utilize_with_use_authority = lpl_token_metadata::instruction::utilize(
            lpl_token_metadata::id(),
            test_metadata.pubkey,
            test_metadata.token.pubkey(),
            test_metadata.mint.pubkey(),
    ...
    async fn multi_use_revoke_delegate_fail() {
        ...
        let revoke_use_authority = lpl_token_metadata::instruction::revoke_use_authority(
            lpl_token_metadata::id(),
            record,
            use_authority.pubkey(),
            context.payer.pubkey(),
        ...
        let utilize_with_use_authority_fail = lpl_token_metadata::instruction::utilize(
            lpl_token_metadata::id(),
            test_metadata.pubkey,
            test_metadata.token.pubkey(),
            test_metadata.mint.pubkey(),
    ...
    async fn success_delegated_and_burn() {
        ...
        let (burner, _) = find_program_as_burner_account();
        let approveix = lpl_token_metadata::instruction::approve_use_authority(
            lpl_token_metadata::id(),
            record,
            use_authority.pubkey(),
            context.payer.pubkey(),
        ...
        let utilize_ix = lpl_token_metadata::instruction::utilize(
            lpl_token_metadata::id(),
            test_meta.pubkey,
            test_meta.token.pubkey(),
            test_meta.mint.pubkey(),
