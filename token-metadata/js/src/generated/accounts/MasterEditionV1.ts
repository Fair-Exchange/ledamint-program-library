...
export class MasterEditionV1 implements MasterEditionV1Args {
  ...
  static gpaBuilder(
    ...
    return beetSafecoin.GpaBuilder.fromStruct(programId, masterEditionV1Beet);
  }
...
export const masterEditionV1Beet = new beet.FixableBeetStruct<MasterEditionV1, MasterEditionV1Args>(
  [
    ...
    ['printingMint', beetSafecoin.publicKey],
    ['oneTimePrintingAuthorizationMint', beetSafecoin.publicKey],
  ],
