...
/**
 * MissingSafeTokenProgram: 'Missing SPL token program'
 *
 * @category Errors
 * @category generated
 */
export class MissingSafeTokenProgramError extends Error {
  readonly code: number = 0x95;
  readonly name: string = 'MissingSafeTokenProgram';
  constructor() {
    super('Missing SPL token program');
    if (typeof Error.captureStackTrace === 'function') {
      Error.captureStackTrace(this, MissingSafeTokenProgramError);
    }
  }
}

createErrorFromCodeLookup.set(0x95, () => new MissingSafeTokenProgramError());
createErrorFromNameLookup.set('MissingSafeTokenProgram', () => new MissingSafeTokenProgramError());
