...
| `log_wrapper`                     |          |        | The Safecoin Program Library Wrapper (spl-noop) program ID.
| `compression_program`             |          |        | The Safecoin Program Library spl-account-compression program ID.
| `system_program`                  |          |        | The Safecoin System Program ID.
...
| `max_buffer_size`                 | 4      | 4    | The minimum concurrency limit of the Merkle tree.  See [Safecoin Program Library documentation](https://docs.rs/spl-account-compression/0.1.3/spl_account_compression/spl_account_compression/fn.init_empty_merkle_tree.html) on this for more details.
...
| `token_metadata_program`          |          |        | Metaplex `TokenMetadata` program ID.
| `token_program`                   |          |        | Safecoin Program Library safe-token program ID. 
| `associated_token_program`        |          |        | Safecoin Program Library safe-associated-token-account program ID. 
| `log_wrapper`                     |          |        | The Safecoin Program Library Wrapper (spl-noop) program ID.
